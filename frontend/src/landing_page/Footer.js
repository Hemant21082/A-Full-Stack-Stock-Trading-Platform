...
function Footer() {
  return (
    <footer style={{ backgroundColor: "rgba(200,200,200,0.1)" }}>
      <div
      ...
      >
        <div className="row">
          ...
          <div className="col">
            <h1 className="fs-4">Account</h1> <br></br>
          ...
          <div className="col">
            <h1 className="fs-4">Support</h1> <br></br>
          ...
          <div className="col">
            <h1 className="fs-4">Company</h1> <br></br>
        ...
        <div>
          <div className="mt-5 text-small text-muted"></div>
        ...
        <div className="row pt-4">
            <div className="col fw-bold text-muted" style = {{display : "flex" , gap : "3%",letterSpacing:"0.2px",fontSize: "16px"}}>
                <a>NSE</a>
                <a>BSE</a>
                <a>MCX</a>
